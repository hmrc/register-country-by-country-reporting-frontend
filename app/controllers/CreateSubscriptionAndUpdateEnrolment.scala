...
trait CreateSubscriptionAndUpdateEnrolment extends Logging {

  val subscriptionService: SubscriptionService
  val taxEnrolmentService: TaxEnrolmentService
  val sessionRepository: SessionRepository

  def createSubscription(safeId: SafeId)(implicit hc: HeaderCarrier, ec: ExecutionContext, request: DataRequest[AnyContent]): Future[Result] =
