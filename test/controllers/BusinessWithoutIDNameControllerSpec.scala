...
class BusinessWithoutIDNameControllerSpec extends SpecBase {
  ...
  lazy val businessWithoutIDNameRoute = routes.BusinessWithoutIDNameController.onPageLoad(NormalMode).url
  ...
  "BusinessWithoutIDName Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, businessWithoutIDNameRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, businessWithoutIDNameRoute)
